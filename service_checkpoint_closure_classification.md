...
3. **Gap-fill provenance — primary basis verified 2026-08-03; per-clause layer still pending (3 events).** `evt_rate_da06f8e602c2b7d9` (sno=3 desc), `evt_rate_3a033ad6f81cd8ed` (sno=3 rate), `evt_rate_3c17bc98bfeb320f` (sno=7 desc) were originally `CONSOLIDATED GAP-FILL … PENDING` placeholders. The **primary statutory basis is now verified against corpus documents** and each event carries:
   - sno=3 events → `source_document_id = /in/union/notifications/cbic/central-tax-rate/2019/3-2019-central-tax-rate` (Notification 3/2019-Central Tax (Rate); affordable-housing / Heading 9954 construction-services restructure, eff 2019-04-01).
   - sno=7 event → `source_document_id = /in/union/notifications/cbic/central-tax-rate/2019/20-2019-central-tax-rate` (Notification 20/2019-Central Tax (Rate); sno=7 Heading 9963 accommodation restructure, eff 2019-10-01).
   - `review_reasons` now includes `primary_basis_verified` alongside the retained `pending_official_citation`.
   
   These corpus documents were confirmed present and topically correct (3/2019 contains "afford"+"construction"; 20/2019 contains "accommodat"+"hotel"+"restaurant"). The closure still reproduces 40/40, 41/41, 41/41 after the edit because `source_cbic_no`/`source_document_id` are provenance metadata not consumed by the materializer. **The per-clause citation set for the post-primary-basis amendments (consolidated through the 54th Service Notification, 2024) remains PENDING** and `pending_official_citation` is retained for that layer — a single precise per-clause citation is not assignable because each gap-fill is an as-at consolidation of dozens of notifications, not a single-instrument amendment. No citation was fabricated.
